...
export function serveStatic(app: Express) {
  ...
  if (!fs.existsSync(distPath)) {
    ...
    if (process.env.NODE_ENV === "production") {
        ...
        res.status(503).send(`
          <html>
            ...
            <body>
              ...
              <p>The application has not been built yet. Please run:</p>
      ...
      // In development, this should never be called, but if it is, throw an error
      throw new Error("serveStatic called in development mode! This should not happen. Check server/index.ts");
    }
  }
